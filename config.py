...
OWNER_ID = int(getenv("OWNER_ID", 5991884735))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/suchendra555")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/suchendra_99")
